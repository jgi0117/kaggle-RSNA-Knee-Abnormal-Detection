...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Existing matching indices are reused; "
            "missing reports are translated with Qwen3-8B."
        ),
    )
...
def load_translation_cache(path):
    ...
    if df["index"].duplicated().any():
        raise ValueError(
            "translations.csv contains duplicate index values."
        )
...
def main():
    ...
    translations_path = resolve_translations_csv(
